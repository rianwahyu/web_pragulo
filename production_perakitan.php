        ...
        <div class="page-wrapper">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Proses Perakitan</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    WHERE a.status='Perakitan' AND queue='1' AND prodStat='0' ";
                                                ...
                                                while ($data = mysqli_fetch_array($result)) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="production_list_detail?productionID=<?= $data['productionID'] ?>&source=production_perakitan">
                                                                ...
                                                                <form class="mt-2" action="config/production/updateProduction.php" method="POST">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <p>Apakah anda ingin mengkonfirmasi proses <strong> Selesai Perakitan</strong> dan melanjutkan ke proses selanjutnya ?</p>
                                                                            ...
                                                                            <input type="hidden" name="pageName" value="production_perakitan" />
                ...
                <div class="row">
                    ...
                    WHERE a.status='Perakitan' AND queue='0' ";
                                                        ...
                                                        <div id="kerjakan<?= $i ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                ...
                                                                <form class="mt-2" action="config/production/updateAntrian.php" method="POST">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title" id="myModalLabel">Konfirmasi Pengerjaan Perakitan</h4>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <input type="hidden" class="form-control" name="itemID" value="<?= $data['itemID'] ?>" />
