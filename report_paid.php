    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
        ...
        <div class="page-wrapper">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Lunas</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                $query = "SELECT a.dateOrder, a.orderID, a.customerName, SUM((b.quantity*b.price)) as total, a.statusPembayaran FROM orders a INNER JOIN order_item b ON a.orderID=b.orderID  WHERE a.statusPembayaran='paid' AND ( a.dateOrder BETWEEN '$start' AND '$end' ) GROUP BY a.orderID ORDER BY a.dateOrder ";
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Periode Laporan Order Lunas</h4>
                    ...
                    <div class="col-md-8 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Daftar order lunas</h6>
                                ...
                                <div class="table-responsive">
                                    <?php if (mysqli_num_rows($result) >= 1) {
                                        ...
                                        <form action="config/report/downloadOrderPaid.php" method="POST" target="_blank" class="mb-4">
