    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Master Toko</h4>
            ...
            <div class="container-fluid">
                ...
                $query = "SELECT a.*, b.categoryName, SUM(COALESCE(c.quantity,0)) as jumlah FROM item a INNER JOIN category b ON a.categoryID=b.categoryID LEFT JOIN store_stock c ON a.itemID=c.itemID WHERE c.itemType='mebel' GROUP BY a.itemID";
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Daftar Persediaan Barang mebel di Toko</h6>
