    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
        ...
        <div class="page-wrapper">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Stok Gudnag</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                $query = "SELECT DATE_FORMAT(a.dateStock, '%Y-%m-%d') as tglStock, a.itemID, b.itemName, a.quantity, a.remark FROM warehouse_stock a INNER JOIN item b ON a.itemID=b.itemID WHERE a.dateStock BETWEEN '$start' AND '$end' ORDER BY a.dateStock ASC ";
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Periode Laporan Stok Gudang</h4>
                    ...
                    <div class="col-md-8 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">List Stok Gudang</h6>
                                ...
                                <div class="table-responsive">
                                    <?php if (mysqli_num_rows($result) >= 1) {
                                        ...
                                        <form action="config/report/downloadWarehouseStock.php" method="POST" target="_blank" class="mb-4">
