        ...
        <div class="page-wrapper">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Proses Pemasangan Jog</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    WHERE a.status='Pemasangan Jog' AND queue='1' AND prodStat='0' ";
                                                                ...
                                                                <form class="mt-2" action="config/production/updateProduction.php" method="POST">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <p>Apakah anda ingin mengkonfirmasi proses <strong> Selesai Pemasangan Jog</strong> dan melanjutkan ke proses selanjutnya ?</p>
                ...
                <div class="row">
                    ...
                    WHERE a.status='Pemasangan Jog' AND queue='0' ";
                    ...
                    <div class="col-sm-12 col-md-10 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Antrian Pemasangan Jog</h4>
                                <h6 class="card-subtitle">Antri Proses Pemasangan Jog</h6>
                                                        ...
                                                        <div id="kerjakan<?= $i ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                ...
                                                                <form class="mt-2" action="config/production/updateAntrian.php" method="POST">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title" id="myModalLabel">Konfirmasi Pengerjaan Pemasangan Jog</h4>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <input type="hidden" class="form-control" name="itemID" value="<?= $data['itemID'] ?>" />
