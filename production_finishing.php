        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    $query = "SELECT a.timelineID, b.orderID, a.productionID, b.itemID, c.itemName, e.fullname, a.note, DATE_FORMAT(a.date, '%Y-%m-%d') as date, DATE_FORMAT(a.dateFinish, '%Y-%m-%d') as dateFinish, a.prodStat, a.status
                    FROM timeline a 
                    ...
                    <div class="col-sm-12 col-md-10 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Daftar Pemasangan Jog</h4>
                                <h6 class="card-subtitle">Proses Pemasangan Jog</h6>
                                                ...
                                                while ($data = mysqli_fetch_array($result)) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="production_list_detail?productionID=<?= $data['productionID'] ?>&source=production_pemasangan_jog">
                                                                ...
                                                                <form class="mt-2" action="config/production/updateProduction.php" method="POST">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <p>Apakah anda ingin mengkonfirmasi proses <strong> Selesai Finishing</strong> ? </p>
                                                                            ...
                                                                            <input type="hidden" name="curentStat" value="<?= $data['status'] ?>" />
                                                                            ...
                                                                            <input type="hidden" name="pageName" value="production_finishing" />
                ...
                <div class="row">
                    ...
                    WHERE a.status='Finishing' AND queue='0' ";
                    ...
                    <div class="col-sm-12 col-md-10 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Antrian Finishing</h4>
                                <h6 class="card-subtitle">Antri Proses Finishing</h6>
                                                        ...
                                                        <div id="kerjakan<?= $i ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                ...
                                                                <form class="mt-2" action="config/production/updateAntrian.php" method="POST">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title" id="myModalLabel">Konfirmasi Pengerjaan Finishing</h4>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <input type="hidden" class="form-control" name="itemID" value="<?= $data['itemID'] ?>" />
