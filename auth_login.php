...
<head>
    ...
    <title>Pragulo - Auth Login</title>
    <!-- Custom CSS -->
...
<body>
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative" style="background:url(src/assets/images/big/auth-bg.jpg) no-repeat center center;">
            <div class="auth-box row">
                <div class="col-lg-7 col-md-5 modal-bg-img" style="background-image: url(src/assets/images/big/furniture.jpg);">
                </div>
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <h2 class="mt-3 text-center">Pragulo</h2>
                        <p class="text-center">Masukkan Username dan Password anda.</p>
                        <form class="mt-4" action="config/checklogin" method="POST">
                            <div class="row">
                                <div class="col-lg-12">
